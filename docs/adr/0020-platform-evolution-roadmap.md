...
- **CAP-084 — Knowledge Graph** — Proposed, deterministic engine implemented (ADR-0023; CAP-084A architecture & governance freeze → CAP-084B deterministic engine). The second Layer 2 capability, mirroring CAP-083's own lifecycle; still unwired into any execution pipeline.
