...
- **CAP-084 — Knowledge Graph** — Proposed, architecture frozen (ADR-0023; CAP-084A architecture & governance freeze). The second Layer 2 capability, mirroring CAP-083's own lifecycle; no engine exists yet.
