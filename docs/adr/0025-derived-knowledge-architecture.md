...
**Cross-reference (citation only, added by ADR-0026, no rule above modified).** ADR-0026 (Organizational Knowledge Architecture & Learning Constitution) gives the "Aggregated Knowledge" and "Learned Knowledge" positions named in the table above their full constitutional treatment — definition, hierarchy, maturity, promotion, retirement, confidence, and explainability — under the more precise names **Organizational Knowledge** and **Learning** respectively. The table, its naming, and every Recommendation in this ADR remain exactly as frozen above.
