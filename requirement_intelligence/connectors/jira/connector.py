...
canonical transformation. Parsing is handled by the JIRA parser layer.
...
class JiraConnector(SourceConnector):
    ...
    def _fetch_from_api(self) -> list[dict[str, Any]]:
        """Fetches raw JIRA records from the JIRA API.
        ...
        raise NotImplementedError(
            "JIRA API-mode ingestion is not yet implemented. It is planned for "
            "the Phase 1 end-state; use FILE mode for now."
        )
