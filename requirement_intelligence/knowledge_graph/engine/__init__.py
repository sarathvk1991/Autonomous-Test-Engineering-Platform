...
:class:`DeterministicHistoricalDatasetProvider`, :class:`FileHistoricalDatasetProvider`,
:class:`HistoricalDataset`, and :class:`HistoricalExecutionRecord` are exported at this
level — for construction by :class:`~requirement_intelligence.knowledge_graph.
knowledge_graph_service.DeterministicKnowledgeGraphService` only. The projection,
analysis, and builder subpackages are internal collaborators: none of them is a
runtime contract, and none is exported from the top-level ``knowledge_graph`` package.
"""
